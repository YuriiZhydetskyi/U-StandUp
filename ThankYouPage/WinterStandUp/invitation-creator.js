...
const INVITATION_TEMPLATES = {
    ...
    intelligent: {
        name: 'Інтелігентний',
        icon: '🎩',
        text: '{Шановний друже/Любий друже}! {Маю честь запросити} тебе на вечір українського зимового стендапу, що відбудеться у неділю, 21 грудня, у Кельні. Було б {надзвичайно приємно} провести {цей час} у твоїй компанії. Впевнений, що вечір буде цікавим і {насиченим гумором}. \nКвитки можна придбати за посиланням: https://secure.wayforpay.com/payment/winterstandup',
        variations: [
            {
    ...
    aggressive: {
        name: 'Агресивний',
        icon: '💪',
        text: 'Здоров, {бичара/лошара/сучара}! Я йду на український стендап в Кельні у неділю 21 грудня. {Хочу подивитись, що за гамно там буде/Було б прикольно там зустрітись, відпочити разом}. {Вечір обіцяє бути хорошим/Не тупи, йдемо разом}. \nКвитки тут: https://secure.wayforpay.com/payment/winterstandup. \nНе прийшов - проїбав!' ,
        variations: [
            {
