...
const INVITATION_TEMPLATES = {
    casual: {
        name: 'Стандартний',
        icon: '😊',
        text: '{Наступного понеділка/У понеділок}, 3 листопада, я йду на {український стендап} у Кьольні. {Буду дуже радий}, якщо ти {приєднаєшся}. Разом буде веселіше і ми зможемо {гарно провести час} не тільки під час стендапу, а й після нього. \nКвитки можеш придбати ось тут: https://secure.wayforpay.com/payment/herbstcologne',
        variations: [
            { 
    ...
    aggressive: {
        name: 'Агресивний',
        icon: '💪',
        text: 'Здоров, {бичара}! Я йду на український стендап в Кьольні у понеділок 3 листопада. {Хочу подивитись, що за гамно там буде}. {Вечір обіцяє бути хорошим}. \nКвитки тут: https://secure.wayforpay.com/payment/herbstcologne. \nНе прийшов - проїбав!' ,
        variations: [
            { 
                word: '{бичара}', 
            ...
            { 
                word: '{Хочу подивитись, що за гамно там буде}', 
                alternatives: [
            ...
            { 
                word: '{Вечір обіцяє бути хорошим}', 
                alternatives: [
