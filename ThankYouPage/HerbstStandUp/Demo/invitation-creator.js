...
const INVITATION_TEMPLATES = {
    casual: {
        name: 'Банальний',
        icon: '😊',
        text: 'Наступного понеділка, 3 листопада, я йду на український стендап у Кьольні. Буду дуже радий, якщо ти приєднаєшся. Разом буде веселіше і ми зможемо гарно провести час не тільки під час стендапу, а й після нього. Квитки можеш придбати ось тут: https://secure.wayforpay.com/payment/herbstcologne',
        variations: [
            { 
                word: 'Наступного понеділка', 
                alternatives: ['У понеділок', '3 листопада', 'Цього понеділка', 'В понеділок'] 
            },
            { 
            ...
            { 
                ...
                alternatives: ['весело провести час', 'відпочити', 'відірватися', 'пожартувати', 'посміятися'] 
            }
        ]
    },
    ...
    intelligent: {
        name: 'Інтелігентний',
        icon: '🎩',
        text: 'Шановний друже! Маю честь запросити тебе на вечір українського стендапу, що відбудеться у понеділок, 3 листопада, у Кьольні. Було б надзвичайно приємно провести цей час у твоїй компанії. Впевнений, що вечір буде цікавим і насиченим гумором. Квитки можна придбати за посиланням: https://secure.wayforpay.com/payment/herbstcologne',
        variations: [
            { 
                word: 'Шановний друже', 
    ...
    aggressive: {
        name: 'Агресивний',
        icon: '💪',
        text: 'Здоров, {бичара/лошара/кореш/братан}! Я йду на український стендап в Кьольні у понеділок 3 листопада. {Хочу подивитись, що за гамно там буде/Було б прикольно там зустрітись, відпочити разом}. {Вечір обіцяє бути хорошим, тому не прийшов - проїбав/Думаю буде весело, тож давай не лінуйся}. Квитки тут: https://secure.wayforpay.com/payment/herbstcologne',
        variations: [
            { 
                word: '{бичара/лошара/кореш/братан}', 
                alternatives: ['бичара', 'лошара', 'кореш', 'братан', 'чувак', 'чел'], 
                custom: true 
            },
            { 
            ...
            { 
                ...
                alternatives: [
                    'Вечір обіцяє бути хорошим, тому не прийшов - проїбав',
                    'Думаю буде весело, тож давай не лінуйся',
                    'Буде жарко, так що рухай',
                    'Не тупи, йдемо разом'
                ], 
                custom: true 
            }
