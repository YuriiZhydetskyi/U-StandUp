    ...
    function buildTemplates() {
        ...
        return {
            ...
            nerdy: {
                name: 'Ботанський',
                icon: '🤓',
                text: `{Шановний представнику виду Homo sapiens}!\n\n{Згідно з метааналізом 47 рецензованих досліджень} у галузі гелотології (науки про сміх), {групова експозиція до комедійного контенту} активує nucleus accumbens та {стимулює вивільнення} дофаміну, серотоніну та β-ендорфінів {на 27% ефективніше}, ніж індивідуальний перегляд.\n\n{${smartDateLabel}}, ${eventDate}, о ${time} {± 0 хвилин} у локації "${city}" відбудеться {контрольований експеримент} з індукції позитивних емоційних станів (n ≈ 100 суб'єктів).\n\nМоя {робоча гіпотеза}: H₁: твоя присутність {статистично значуще} (p < 0.001) покращить мій суб'єктивний досвід заходу. {Нульова гіпотеза буде відхилена з ймовірністю 99.7%}.\n\nРеєстрація в експериментальну групу: ${paymentUrl}\n\n{P.S. Побічні ефекти можуть включати}: біль у м'язах живота, сльози (етіологія: радість), та спонтанне бажання повторити експеримент.`,
                variations: [
                    {
                        word: `{${smartDateLabel}}`,
                        alternatives: [smartDateLabel, eventDate],
                    ...
                    {
                        word: '{Згідно з метааналізом 47 рецензованих досліджень}',
                        alternatives: [
                            'Згідно з метааналізом 47 рецензованих досліджень',
                            'За даними Кокранівського систематичного огляду',
                            'Як свідчать результати подвійного сліпого дослідження',
                            'Відповідно до останніх публікацій у Nature Neuroscience'
                        ],
                        custom: true
                    },
                    {
                        word: '{групова експозиція до комедійного контенту}',
                        alternatives: [
                            'групова експозиція до комедійного контенту',
                            'колективне споживання гумористичних стимулів',
                            'синхронізований перегляд жартівливого матеріалу',
                            'спільна рецепція сатиричного контенту'
                        ],
                        custom: true
                    },
                    {
                    ...
                    {
                        word: '{на 27% ефективніше}',
                        alternatives: [
                            'на 27% ефективніше',
                            'з коефіцієнтом 1.27',
                            'на 1.3 стандартних відхилення вище',
                            'з effect size d = 0.8'
                        ],
                        custom: true
                    },
                    {
                        ...
                        alternatives: [
                            '± 0 хвилин',
                            '(σ = 0)',
                            'з нульовою дисперсією',
                            'без статистичної похибки'
                        ],
                        custom: true
                    },
                    {
                        word: '{контрольований експеримент}',
                        alternatives: [
                            'контрольований експеримент',
                            'рандомізоване дослідження',
                            'емпіричний експеримент',
                            'лонгітюдне спостереження'
                        ],
                        custom: true
                    },
                    {
                    ...
                    {
                        word: '{Нульова гіпотеза буде відхилена з ймовірністю 99.7%}',
                        alternatives: [
                            'Нульова гіпотеза буде відхилена з ймовірністю 99.7%',
                            'Довірчий інтервал не включатиме нуль',
                            'Статистична потужність тесту наближається до 1',
                            'Ефект буде відтворюваним (r = 0.95)'
                        ],
                        custom: true
                    },
                    {
                        word: '{P.S. Побічні ефекти можуть включати}',
                        alternatives: [
                            'P.S. Побічні ефекти можуть включати',
                            'Увага: зафіксовані небажані реакції включають',
                            'Дисклеймер: серед побічних явищ спостерігались',
            ...
            corporate: {
                name: 'Корпоративний',
                icon: '👔',
                text: `{МЕМОРАНДУМ}\n\nДо: {Шановний колего/колежанко}\nВід: Департамент Entertainment & Well-being\nТема: {Запрошення на тімбілдінговий захід}\n\n{Цим повідомленням офіційно інформую} про проведення {стратегічного заходу} з {оптимізації рівня задоволеності} та розвитку soft skills.\n\n{Деталі}:\n• Дата: {${smartDateLabel}}, ${eventDate}\n• Час: ${time}\n• Локація: ${city}\n• Формат: Український стендап-концерт\n• Dress code: {Business casual}\n\n{Очікувані KPI}:\n— Підвищення рівня ендорфінів на 200%\n— {Синергія сміху} в команді\n— Networking у неформальній атмосфері\n— {Win-win для всіх стейкхолдерів}\n\nПросимо підтвердити участь: ${paymentUrl}\n\n{Action items}: придбати квиток → з'явитися → сміятися → {вийти за рамки зони комфорту}.\n\n{З повагою та найкращими побажаннями щодо досягнення ваших особистих KPI}.`,
                variations: [
                    {
                        word: `{${smartDateLabel}}`,
                        alternatives: [smartDateLabel, eventDate],
                    ...
                    },
                    {
                        ...
                        alternatives: [
                            ...
                            'Re: Q4 Entertainment Initiative',
                            'Invitation: Cross-functional Fun Event',
                            'URGENT: Happiness Optimization Session'
                        ],
                        custom: true
                    },
                    {
                        ...
                        alternatives: [
                            ...
                            'Following up on the happiness initiative',
                            'Відповідно до стратегії well-being'
                        ],
                        custom: true
                    },
                    {
                    ...
                    },
                    {
                        ...
                        alternatives: [
                            ...
                            'максимізації employee happiness',
                            'імплементації fun-first підходу',
                            'реалізації joy-driven methodology'
                        ],
                        custom: true
                    },
                    {
                    ...
                    {
                        word: '{Win-win для всіх стейкхолдерів}',
                        alternatives: [
                            'Win-win для всіх стейкхолдерів',
                            'Scalable fun experience',
                    ...
                    {
                        word: '{вийти за рамки зони комфорту}',
                        alternatives: [
                    ...
                    {
                        word: '{З повагою та найкращими побажаннями щодо досягнення ваших особистих KPI}',
                        alternatives: [
                            'З повагою та найкращими побажаннями щодо досягнення ваших особистих KPI',
                            'Best regards & good vibes',
                            'Let\'s circle back on this ASAP',
                            'Looking forward to syncing offline'
                        ],
                        custom: true
                    }
                ]
